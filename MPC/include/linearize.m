...
% Cx + d, where C = dg/dx. Both linear approximations are only reasonable
% for x "close" to x_est, which we assume to hold over MPC's finite
% horizon. For example, the linearization of the dynamics proceeds as
% follows:
%
...
function [A, B, C, c, d] = linearize(arm, space)
