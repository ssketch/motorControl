...
B21 = arm.m4*arm.s4^2*sin(2*arm.q(3))*sin(arm.q(4))^2;
...
% [q_dot*q_dot ]
qdqd = [ arm.q(5)*arm.q(6);   % th1_dot*th2_dot
         arm.q(5)*arm.q(7);   % th1_dot*th3_dot
         arm.q(5)*arm.q(8);   % th1_dot*th4_dot
         arm.q(6)*arm.q(7);   % th2_dot*th3_dot
         arm.q(6)*arm.q(8);   % th2_dot*th4_dot
         arm.q(7)*arm.q(8) ]; % th3_dot*th4_dot
     
     
     
% Centrifugal
C11 = arm.m4*arm.s4^2*cos(arm.q(2))^2*cos(arm.q(4))*sin(arm.q(3))*...
    sin(arm.q(4)) - (arm.m3*arm.s3^2*sin(2*arm.q(2)))/2 - ...
    arm.m4*arm.s4^2*cos(arm.q(2))*cos(arm.q(4))^2*sin(arm.q(2)) - ...
    2*arm.l3*arm.m4*arm.s4*cos(arm.q(2))*cos(arm.q(4))*sin(arm.q(2)) - ...
    (arm.l3^2*arm.m4*sin(2*arm.q(2)))/2 - ...
    arm.m4*arm.s4^2*cos(arm.q(4))*sin(arm.q(2))^2*sin(arm.q(3))*...
    sin(arm.q(4)) + ...
    arm.l3*arm.m4*arm.s4*cos(arm.q(2))^2*sin(arm.q(3))*sin(arm.q(4)) - ...
    arm.l3*arm.m4*arm.s4*sin(arm.q(2))^2*sin(arm.q(3))*sin(arm.q(4)) + ...
    arm.m4*arm.s4^2*cos(arm.q(2))*sin(arm.q(2))*sin(arm.q(3))^2*...
    sin(arm.q(4))^2;
C12 = (arm.m4*arm.s4^2*sin(2*arm.q(3))*cos(arm.q(4))^2)/2 - ...
    arm.I4*cos(arm.q(1))*cos(arm.q(2)) - ...
    (arm.m4*arm.s4^2*sin(2*arm.q(3)))/2 - ...
    arm.I3*cos(arm.q(1))*cos(arm.q(2));
C13 = arm.I3*sin(arm.q(1)) + arm.I4*sin(arm.q(1)) - ...
    (arm.m4*arm.s4^2*sin(2*arm.q(4)))/2;
C14 = arm.I4*cos(arm.q(1) - arm.q(4)) - arm.m4*arm.s4;

C21 = arm.l3^2*arm.m4*cos(arm.q(2))^2 - ...
    arm.I4*cos(arm.q(2))*sin(arm.q(1)) - ...
    arm.I3*cos(arm.q(2))*sin(arm.q(1)) + ...
    arm.m3*arm.s3^2*cos(arm.q(2))^2 - ...
    arm.l3^2*arm.m4*sin(arm.q(2))^2 - ...
    arm.m3*arm.s3^2*sin(arm.q(2))^2 + ...
    arm.m4*arm.s4^2*cos(arm.q(2))^2*cos(arm.q(4))^2 - ...
    arm.m4*arm.s4^2*cos(arm.q(4))^2*sin(arm.q(2))^2 - ...
    arm.m4*arm.s4^2*cos(arm.q(2))^2*sin(arm.q(3))^2*sin(arm.q(4))^2 + ...
    arm.m4*arm.s4^2*sin(arm.q(2))^2*sin(arm.q(3))^2*sin(arm.q(4))^2 + ...
    2*arm.l3*arm.m4*arm.s4*cos(arm.q(2))^2*cos(arm.q(4)) - ...
    2*arm.l3*arm.m4*arm.s4*cos(arm.q(4))*sin(arm.q(2))^2 + ...
    4*arm.m4*arm.s4^2*cos(arm.q(2))*cos(arm.q(4))*sin(arm.q(2))*...
    sin(arm.q(3))*sin(arm.q(4)) + ...
    4*arm.l3*arm.m4*arm.s4*cos(arm.q(2))*sin(arm.q(2))*sin(arm.q(3))*...
    sin(arm.q(4));
C22 = -arm.m4*arm.s4^2*cos(2*arm.q(3))*(cos(arm.q(4))^2 - 1);
C23 = -arm.m4*arm.s4^2*cos(2*arm.q(4));
C24 = -arm.m4;

C31 = 4*arm.m4*arm.s4^2*cos(arm.q(2))^2*cos(arm.q(4))*sin(arm.q(3))*...
    sin(arm.q(4)) - arm.I4*sin(arm.q(1)) - ...
    2*arm.l3^2*arm.m4*sin(2*arm.q(2)) - ...
    2*arm.m3*arm.s3^2*sin(2*arm.q(2)) - ...
    4*arm.m4*arm.s4^2*cos(arm.q(2))*cos(arm.q(4))^2*sin(arm.q(2)) - ...
    8*arm.l3*arm.m4*arm.s4*cos(arm.q(2))*cos(arm.q(4))*sin(arm.q(2)) - ...
    arm.I3*sin(arm.q(1)) - ...
    4*arm.m4*arm.s4^2*cos(arm.q(4))*sin(arm.q(2))^2*sin(arm.q(3))*...
    sin(arm.q(4)) + ...
    4*arm.l3*arm.m4*arm.s4*cos(arm.q(2))^2*sin(arm.q(3))*sin(arm.q(4)) -...
    4*arm.l3*arm.m4*arm.s4*sin(arm.q(2))^2*sin(arm.q(3))*sin(arm.q(4)) +...
    4*arm.m4*arm.s4^2*cos(arm.q(2))*sin(arm.q(2))*sin(arm.q(3))^2*...
    sin(arm.q(4))^2;
C32 = 2*arm.m4*arm.s4^2*sin(2*arm.q(3))*sin(arm.q(4))^2;
C33 = -2*arm.m4*arm.s4^2*sin(2*arm.q(4));
C34 = 0;

C41 = arm.I4*cos(arm.q(1))*sin(arm.q(4)) - ...
    arm.I4*cos(arm.q(4))*sin(arm.q(1)) - ...
    4*arm.l3^2*arm.m4*cos(arm.q(2))^2 - ...
    4*arm.m3*arm.s3^2*cos(arm.q(2))^2 + ...
    4*arm.l3^2*arm.m4*sin(arm.q(2))^2 + ...
    4*arm.m3*arm.s3^2*sin(arm.q(2))^2 - ...
    4*arm.m4*arm.s4^2*cos(arm.q(2))^2*cos(arm.q(4))^2 + ...
    4*arm.m4*arm.s4^2*cos(arm.q(4))^2*sin(arm.q(2))^2 + ...
    4*arm.m4*arm.s4^2*cos(arm.q(2))^2*sin(arm.q(3))^2*sin(arm.q(4))^2 - ...
    4*arm.m4*arm.s4^2*sin(arm.q(2))^2*sin(arm.q(3))^2*sin(arm.q(4))^2 - ...
    8*arm.l3*arm.m4*arm.s4*cos(arm.q(2))^2*cos(arm.q(4)) + ...
    8*arm.l3*arm.m4*arm.s4*cos(arm.q(4))*sin(arm.q(2))^2 - ...
    16*arm.m4*arm.s4^2*cos(arm.q(2))*cos(arm.q(4))*sin(arm.q(2))*...
    sin(arm.q(3))*sin(arm.q(4)) - ...
    16*arm.l3*arm.m4*arm.s4*cos(arm.q(2))*sin(arm.q(2))*sin(arm.q(3))*...
    sin(arm.q(4));
C42 = -4*arm.m4*arm.s4^2*cos(2*arm.q(3))*(cos(arm.q(4))^2 - 1);
C43 = 4*arm.m4*arm.s4^2*cos(2*arm.q(4));
C44 = 0;
...
V = B*qdqd + C*arm.q(5:8).^2;
  
  

% Gravity  
G1 = (9.81*arm.m4*(arm.s4*(sin(arm.q(4))*(cos(arm.q(1))*cos(arm.q(3)) + ...
    sin(arm.q(1))*sin(arm.q(2))*sin(arm.q(3))) + ...
    cos(arm.q(2))*cos(arm.q(4))*sin(arm.q(1))) + ...
    arm.l3*cos(arm.q(2))*sin(arm.q(1)))) + ...
    (9.81*arm.m3*arm.s3*cos(arm.q(2))*sin(arm.q(1)));
G2 = (9.81*arm.m4*cos(arm.q(1))*(arm.l3*sin(arm.q(2)) + ...
    arm.s4*cos(arm.q(4))*sin(arm.q(2)) - ...
    arm.s4*cos(arm.q(2))*sin(arm.q(3))*sin(arm.q(4)))) + ...
    (9.81*arm.m3*arm.s3*cos(arm.q(1))*sin(arm.q(2)));
G3 = -(9.81*arm.m4*arm.s4*sin(arm.q(4))*(sin(arm.q(1))*sin(arm.q(3)) + ...
    cos(arm.q(1))*cos(arm.q(3))*sin(arm.q(2))));
G4 = (9.81*arm.m4*arm.s4*(cos(arm.q(4))*(cos(arm.q(3))*sin(arm.q(1)) - ...
    cos(arm.q(1))*sin(arm.q(2))*sin(arm.q(3))) + ...
    cos(arm.q(1))*cos(arm.q(2))*sin(arm.q(4))));


G = [ G1; G2; G3; G4 ];


Fric = arm.B*arm.q(5:8);

f = [ arm.q(5:8); M\(u - V - G - Fric)];
